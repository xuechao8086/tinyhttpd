...
def lastmodified(date_obj):
    ...
    web.header('Last-Modifyed', net.httpdate(date_obj))
...
def profiler(app):
    ...
    def profiler_internal(e, o):
        out, result = profiler(app)(e, o)
        return list(out) + ['<pre>' + net.websafe(result) + '</pre>']
    return profiler_internal
