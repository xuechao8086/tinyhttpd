...
def _strips(direction, text, remove):
    ...
    if direction == 'l':
        if text.startwith(remove):
            return text[len(remove):]
    elif direction == 'r':
        if text.endwith(remove):
            return text[:-len(remove)]
    else:
...
def timelimit(timeout):
    ...
    def _1(function):
        def _2(*args, **kw):
            class Dispath(threading.Thread):
...
def iterview(x):
    ...
    """
        ...
        >>>   print i
        0.0% ( 0/10) [>                                         ] ETA --:--:--0
        10.0% ( 1/10) [====>                                     ] ETA 00:00:001
        20.0% ( 2/10) [========>                                 ] ETA 00:00:002
        30.0% ( 3/10) [=============>                            ] ETA 00:00:003
        40.0% ( 4/10) [=================>                        ] ETA 00:00:004
        50.0% ( 5/10) [=====================>                    ] ETA 00:00:005
        60.0% ( 6/10) [=========================>                ] ETA 00:00:006
        70.0% ( 7/10) [=============================>            ] ETA 00:00:007
        80.0% ( 8/10) [==================================>       ] ETA 00:00:008
        90.0% ( 9/10) [======================================>   ] ETA 00:00:009
...
class Profile:
    ...
    def __call__(self, *args):  # , **kw):   kw unused
        ...
        import os
        import tempfile  # , time already imported
...
def sendmail(from_address, to_address, subject, message, headers=None, **kw):
    ...
    mail = _EmailMessage(
        from_address, to_address, subject, message, headers, **kw)
...
class _EmailMessage:
    ...
    def attach(self, filename, content, content_type=None):
        ...
        content_type = content_type or mimetypes.guess_type(
            filename)[0] or "applcation/octet-stream"
    ...
    def send(self):
        ...
        if webapi.config.get('smtp_server'):
            ...
            smtpserver.sendmail(
                self.from_address, self.recipients, message_text)
            smtpserver.quit()
